...
static const _urlSearchMovies= "https://api.themoviedb.org/3/search/movie?api_key=${ApiKey.apiKey}&query=";
...
return await apiFunction("${_urlSearchMovies}$query");
 }
 Future<String>  getMoviesVideo(int movieId) async{
String _urlMoviesVideo= "https://api.themoviedb.org/3/movie/$movieId/videos?api_key=${ApiKey.apiKey}";
