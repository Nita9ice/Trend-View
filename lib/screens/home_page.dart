...
FutureBuilder(
                future: Future.wait([trendingMovies, actionMovies, comedyMovies,dramaMovies, horrorMovies,sciFiMovies,]),
            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                MaterialPageRoute(
                  builder:
                      (context) =>  MovieScreen(snapshot: snapshot,heading:categories[index], futureindex: index),
                ),
              );
